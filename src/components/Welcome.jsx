...
const Welcome = () => {
  useEffect(() => {
    ...
    // NOTE: removed disabling scrolling per requirements
    // Re-enable any previous changes on unmount if needed (none done here)
    return () => {
      // nothing to cleanup related to overflow anymore
    };
  }, []);
      ...
      <div className="gradient-bg min-h-screen font-sans">
        <div className="container mx-auto px-4 pt-6 md:pt-10 pb-8 relative">
          ...
          <nav className="flex justify-between items-center mb-16 relative pt-2 md:pt-0">
            {/* Centered Title + Icon */}
            <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center space-x-4 center-title-wrapper">
            ...
            {/* Top-right buttons (will reposition under the title at <=1024px & <=768px) */}
            <div className="nav-buttons flex space-x-4 ml-auto">
          ...
          {/* Main Section */}
          <main className="flex flex-col md:flex-row items-center justify-between gap-12 main-section">
            {/* Left Content */}
            <div className="md:w-1/2 ml-8 left-content">
              ...
              <p className="text-lg text-gray-600 mb-10 max-w-lg ml-12 intro-paragraph">
            ...
            {/* Right Chat Card */}
            <div className="md:w-1/2 relative chat-wrap">
              <div className="relative">
                ...
                <div className="relative bg-white p-6 rounded-3xl shadow-xl max-w-md mx-auto chat-card">
